...
import sty from "./PlasmicProductCard.module.css"; // plasmic-import: cI83_cFB8SXTQl/css
import ShoppingCartIcon from "./icons/PlasmicIcon__ShoppingCart"; // plasmic-import: fB7OLnXBcVewEi/icon
import HeartOIcon from "./icons/PlasmicIcon__HeartO"; // plasmic-import: wgvR_AupGN6fce/icon
import ExpandIcon from "./icons/PlasmicIcon__Expand"; // plasmic-import: cIQ_frGlhBk92b/icon
...
function PlasmicProductCard__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__m4BX)}>
        {p.renderPlasmicSlot({
          defaultContents: (
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__iuCI)}
              displayHeight={"auto"}
              ...
              displayWidth={"100%"}
              src={{
                src: "/plasmic/copy_of_planty/images/f1.jpeg",
                fullWidth: 270,
                fullHeight: 310,
        ...
        {(hasVariant(variants, "onSale", "onSale") ? true : true) ? (
          <div
            className={classNames(projectcss.all, sty.freeBox__jaKAk, {
              [sty.freeBoxonSale__jaKAkRctpc]: hasVariant(
                variants,
                "onSale",
                "onSale"
              )
        ...
        {(triggers.hover_root ? true : true) ? (
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__xZqBx)}
          >
            <ShoppingCartIcon
              className={classNames(projectcss.all, sty.svg__aPoPe)}
              role={"img"}
            />
            ...
            <HeartOIcon
              className={classNames(projectcss.all, sty.svg__hdj0E)}
              role={"img"}
            />

            <ExpandIcon
              className={classNames(projectcss.all, sty.svg__i6B2I)}
              role={"img"}
            />
          </p.Stack>
        ) : null}
      ...
      {(hasVariant(variants, "withReviews", "withReviews") ? true : true)
        ? p.renderPlasmicSlot({
            defaultContents: (
              <Ratings
                className={classNames("__wab_instance", sty.ratings__c4MSv)}
              />
            ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___6L32)}
      >
        {p.renderPlasmicSlot({
