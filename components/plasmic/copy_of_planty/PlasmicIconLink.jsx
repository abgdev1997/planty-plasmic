...
import sty from "./PlasmicIconLink.module.css"; // plasmic-import: RewbbDsDEQiYmI/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg___3NZmg)}
              role={"img"}
            />
          ),
