...
import sty from "./PlasmicButton.module.css"; // plasmic-import: Ak1xcrUCc58Wy7/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: Q_QHFpx2aD_vAl/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__hQjJf)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__xKqfY)}
                role={"img"}
              />
            ),
