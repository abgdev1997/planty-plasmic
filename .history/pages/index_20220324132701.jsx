...
function Home() {
  ...
  return <PlasmicHome ctaHero={<Button className="cta_hero" color="yellow"> <div style={{alignItems: 'center' justifyContent: 'center'}}>{'Empieza ya'} <ButtonArrowIcon style={{}}></ButtonArrowIcon></div></Button>}/>;
}
