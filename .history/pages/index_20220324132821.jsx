...
function Home() {
  ...
  return <PlasmicHome ctaHero={<Button className="cta_hero" color="yellow"> <div style={{display: "flex" flexDirection="row"}}>{'Empieza ya'} <ButtonArrowIcon></ButtonArrowIcon></div></Button>}/>;
}
